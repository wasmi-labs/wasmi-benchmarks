...
impl VmAndConfig {
    ...
    fn label(&self) -> &str {
        match self {
            ...
            Self::Wasmi031 => "Wasmi 0.31",
            Self::Wasmi032 => "Wasmi 0.32",
            Self::WasmiV1(WasmiConfig::Checked) => "Wasmi 1.0 (eager)",
            Self::WasmiV1(WasmiConfig::Unchecked) => "Wasmi 1.0 (eager, unchecked)",
            Self::WasmiV1(WasmiConfig::Lazy) => "Wasmi 1.0 (lazy)",
            Self::WasmiV1(WasmiConfig::LazyUnchecked) => "Wasmi 1.0 (lazy, unchecked)",
            Self::WasmiV1(WasmiConfig::LazyTranslation) => "Wasmi 1.0 (lazy-translation)",
            Self::WasmiV2(WasmiConfig::Checked) => "Wasmi 2.0 (eager)",
            Self::WasmiV2(WasmiConfig::Unchecked) => "Wasmi 2.0 (eager, unchecked)",
            Self::WasmiV2(WasmiConfig::Lazy) => "Wasmi 2.0 (lazy)",
            Self::WasmiV2(WasmiConfig::LazyUnchecked) => "Wasmi 2.0 (lazy, unchecked)",
            Self::WasmiV2(WasmiConfig::LazyTranslation) => "Wasmi 2.0 (lazy-translation)",
