...
impl VmAndConfig {
    ...
    fn label(&self) -> &str {
        match self {
            ...
            Self::WasmiV2Beta8(WasmiConfig::Checked) => "Wasmi v2-beta.8 (eager)",
            Self::WasmiV2Beta8(WasmiConfig::Unchecked) => "Wasmi v2-beta.8 (eager, unchecked)",
            Self::WasmiV2Beta8(WasmiConfig::Lazy) => "Wasmi v2-beta.8 (lazy)",
            Self::WasmiV2Beta8(WasmiConfig::LazyUnchecked) => "Wasmi v2-beta.8 (lazy, unchecked)",
            Self::WasmiV2Beta8(WasmiConfig::LazyTranslation) => "Wasmi v2-beta.8 (lazy-translation)",
...
impl FromStr for VmAndConfig {
    ...
    fn from_str(input: &str) -> Result<Self, Self::Err> {
        let vm_and_config = match input {
            ...
            "wasmi-v2-beta-8.eager.checked" => Self::WasmiV2Beta8(WasmiConfig::Checked),
            "wasmi-v2-beta-8.eager.unchecked" => Self::WasmiV2Beta8(WasmiConfig::Unchecked),
            "wasmi-v2-beta-8.lazy.checked" => Self::WasmiV2Beta8(WasmiConfig::Lazy),
            "wasmi-v2-beta-8.lazy.unchecked" => Self::WasmiV2Beta8(WasmiConfig::LazyUnchecked),
            "wasmi-v2-beta-8.lazy-translation.checked" => Self::WasmiV2Beta8(WasmiConfig::LazyTranslation),
