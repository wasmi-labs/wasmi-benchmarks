...
/// A concrete Wasmi runtime with its linker, produced by [`WasmiV031::setup`].
...
fn to_wasmi_valtype(ty: utils::ValType) -> wasmi::core::ValueType {
    match ty {
        utils::ValType::I32 => wasmi::core::ValueType::I32,
        utils::ValType::I64 => wasmi::core::ValueType::I64,
        utils::ValType::F32 => wasmi::core::ValueType::F32,
        utils::ValType::F64 => wasmi::core::ValueType::F64,
    }
}
