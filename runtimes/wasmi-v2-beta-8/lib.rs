...
impl Runtime for Wasmi {
    fn id(&self) -> &'static str {
        match (self.compilation_mode, self.validation) {
            (CompilationMode::Eager, Validation::Checked) => "wasmi-v2-beta-8.eager.checked",
            (CompilationMode::Eager, Validation::Unchecked) => "wasmi-v2-beta-8.eager.unchecked",
            (CompilationMode::LazyTranslation, Validation::Checked) => {
                "wasmi-v2-beta-8.lazy-translation.checked"
            }
            (CompilationMode::LazyTranslation, Validation::Unchecked) => {
                "wasmi-v2-beta-8.lazy-translation.unchecked"
            }
            (CompilationMode::Lazy, Validation::Checked) => "wasmi-v2-beta-8.lazy.checked",
            (CompilationMode::Lazy, Validation::Unchecked) => "wasmi-v2-beta-8.lazy.unchecked",
        }
    }
